        ...
        <div class="card border border-dark rounded shadow-sm overflow-hidden">
          <div class="card-body p-0">
            <div class="row gy-3 gy-md-4 gy-lg-0">
              <div class="col-12 col-lg-6 bsb-overlay background-position-center background-size-cover" style="--bsb-overlay-opacity: 0.7; background-image: url('./img/pexels-nammau-15361528.jpg');">
                    ...
                    <div class="contact-info-wrapper py-4 py-xl-5">
                      ...
                      <div class="d-flex mb-4 mb-xxl-5">
                        ...
                        <div>
                          ...
                          <address class="mb-0 text-light opacity-75">404-North View towers, Besant Nagar, Chennai</address>
                        </div>
                      </div>
                        ...
                        <div class="col-12 col-xxl-6">
                          <div class="d-flex mb-4 mb-xxl-0">
                            ...
                            <div>
                              ...
                              <p class="mb-0">
                                <a class="link-light link-opacity-75 link-opacity-100-hover text-decoration-none" href="tel:+15057922430">(+91) 9876543210</a>
                              </p>
                            </div>
                          </div>
                        </div>
                      ...
                      <div class="d-flex">
                        ...
                        <div>
                          <h4 class="mb-3 text-light">Socials</h4>
                          <div class="d-flex mb-1">
                            <p class="text-light fw-bold mb-0 me-5">Discord Community</p>
                            <a class="link-light link-opacity-75 link-opacity-100-hover text-decoration-none" href="https://discord.gg/pksshBaFb6">GoodBooks - EBook Community</a>
                          </div>
                        </div>
                      </div>
                    </div>
